...
int main()
{
    ...
    //nanovdb::WenoStencil<nanovdb::NanoGrid<float>> stencil(*nano_grid);

    //stencil.moveTo(nanovdb::Coord(1, 2, 3));
    //std::cout << stencil.laplacian() << "\n";
}
...
//#include "Common.h"
//#include "GridFunc.h"
//#include "LaplacianTests.h"
//#include "ConjugateGradientTests.h"
...
//	Calc_Laplacian_Index<float> << <1, 512 >> > (nullptr, nullptr, nullptr);
//
//	TestNanoVDB(argc, argv);
//	//Test_Regular_Laplacian(Eigen::Vector3i(100, 100, 100));
//	//Test_DataContainer<nanovdb::FloatGrid>(Eigen::Vector3i(100, 100, 100));
//	//Test_Dot_Product<nanovdb::FloatGrid>(Eigen::Vector3i(100, 100, 100));
//	//Test_Conjugate_Gradient_Box<nanovdb::FloatGrid>(Eigen::Vector3i(100, 100, 100));
//
//	return 0;
//}